...
class TCompBTagresive : public TCompBase {
...
public:
	...
	static void registerMsgs() {
		DECL_MSG(TCompBTagresive, TMsgAttacker, whoIsAttacker);
		DECL_MSG(TCompBTagresive, TMsgDestroyMe, destroyMe);
...
DECL_OBJ_MANAGER("bt_agresive", TCompBTagresive)