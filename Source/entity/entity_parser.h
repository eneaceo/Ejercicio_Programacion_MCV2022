...
struct TEntityParseContext {
  ...
  // An array of the handles currenty registered in the main file
  VHandles             entities_loaded;

  // Includes all entities, including children of prefabs of principal entities
  VHandles             all_entities_loaded;
